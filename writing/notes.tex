...
\begin{equation}\label{eqn:puttogether}
\begin{aligned}
&\frac{d^2}{dt^2}\text{Mag}(tB_2^d)\big\vert_{t=0} = \\
...
\begin{equation}\label{eqn:skipfactomega2}
\begin{aligned}
...
\end{equation}
And similarly:
\begin{equation}\label{eqn:skipfactomega0}
\begin{aligned}
...
Using the (\ref{eqn:skipfactomega0}), we can rewrite the last sum in (\ref{eqn:puttogether}) as the following:
\begin{equation*}
