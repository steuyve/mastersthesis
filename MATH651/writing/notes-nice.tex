...
We first define the magnitude of a matrix and the magnitude of a finite metric space.
...
Given a finite metric space $A$, we have a one parameter family of matrices $tA$ where the distances in $A$ are scaled by a real parameter $t > 0$.
